...
@SourceType(value = "ParquetARP", label = "Parquet",uiConfig = "parquet-layout.json")
public class ParquetConf extends AbstractArpConf<ParquetConf> {
  private static final String ARP_FILENAME = "arp/implementation/parquet-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.parquet.ParquetDriver";
